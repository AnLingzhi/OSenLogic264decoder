...
`define ext_buf_mem_rd_data_width 64
...
`define slice_header_end1                         5'b10001
...
//slice_data_state
`define rst_slice_data_s                          5'b0000
`define rst_macroblock_s                          5'b0001
`define mb_skip_run_s                             5'b0011
`define skip_run_duration                         5'b0010
`define mb_type_s                                 5'b0110
`define mb_pred                                   5'b0111
`define sub_mb_pred                               5'b0101
`define coded_block_pattern_s                     5'b0100
`define mb_qp_delta_s                             5'b1100
`define residual                                  5'b1101
`define mb_num_update                             5'b1111
`define store_to_fpga_ram                         5'b1110
`define prefetch_from_fpga_ram                    5'b1010
`define rbsp_trailing_bits_slice_data             5'b1011
`define p_skip_s                                  5'b1000
`define skip_run_save_mv                          5'b1001
`define mb_num_update_post                        5'b10000
`define sd_forward_to_next_frame                  5'b10001
`define mb_qp_delta_post_s                       5'b10010
`define sd_reset_frame                           5'b10011
`define pre_store_to_fpga_ram                    5'b10111


//mb_pred_state
`define rst_mb_pred                    4'b0000
`define prev_intra4x4_pred_mode_flag_s 4'b0001
`define rem_intra4x4_pred_mode_s       4'b0011
`define luma_blk4x4_index_update       4'b0010
`define intra_pred_mode_chroma_s       4'b0110
`define ref_idx_l0_s                   4'b0111
`define mvdx_l0_s                      4'b0101
`define mvdy_l0_s                      4'b1100
`define mv_calc_l0_s                  4'b0100
...
`define sub_mv_calc_l0_s      3'b101
...
`define bitstream_forward_to_next_nalu     3'b101
